  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        isScrolled
          ? 'bg-white/80 dark:bg-slate-950/80 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/80 shadow-xs py-3'
          : 'bg-transparent py-5'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
              ...
              return (
                <a
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 ${
                    isActive
                      ? 'text-indigo-600 dark:text-teal-400 bg-indigo-50 dark:bg-teal-950/50 font-semibold'
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Search className="w-4 h-4 text-indigo-500 dark:text-teal-400" />
                ...
                return (
                  <a
                    ...
                    className={`block px-4 py-2.5 rounded-xl text-base font-medium transition-colors ${
                      isActive
                        ? 'bg-indigo-50 dark:bg-teal-950/60 text-indigo-600 dark:text-teal-400 font-semibold'
