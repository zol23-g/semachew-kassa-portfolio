...
export const Logo: React.FC<LogoProps> = ({ className = '', size = 40 }) => {
  return (
    <div className={`inline-flex items-center gap-2.5 group cursor-pointer ${className}`}>
      <div className="relative flex items-center justify-center rounded-xl bg-gradient-to-tr from-[#214E34] via-[#2D734F] to-[#3AB09E] p-0.5 shadow-md shadow-[#214E34]/20 transition-all duration-300 group-hover:scale-105 group-hover:shadow-[#214E34]/40">
        <div className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-slate-950 text-white font-bold tracking-tighter">
          <svg
            ...
            className="text-[#3AB09E] transition-transform duration-300 group-hover:rotate-6"
          >
      ...
      <div className="flex flex-col">
        <span className="text-base font-extrabold tracking-tight text-slate-900 dark:text-white leading-none group-hover:text-[#214E34] dark:group-hover:text-[#3AB09E] transition-colors">
          SMK
        </span>
